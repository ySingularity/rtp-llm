...
std::string VitConfig::to_string() const {
    ...
    oss << "vit_separation: " << vit_sep_str << ", mm_rdma_enable: " << mm_rdma_enable
        << ", mm_rdma_port: " << mm_rdma_port << ", mm_rdma_min_bytes: " << mm_rdma_min_bytes
        << ", mm_rdma_connect_timeout_ms: " << mm_rdma_connect_timeout_ms
        << ", mm_rdma_qp_count_per_connection: " << mm_rdma_qp_count_per_connection
        << ", mm_rdma_io_thread_count: " << mm_rdma_io_thread_count
        << ", mm_rdma_worker_thread_count: " << mm_rdma_worker_thread_count
